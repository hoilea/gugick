...
<body>
	...
	<div class="box-container">
		...
		<form method="post" action="join1Ok.jsp" onsubmit="return check()" accept-charset="utf-8"
			class="form-box" >
			...
			<table class="table input_table">
				...
				<tr>
					<th><span>성별</span></th>
					<td><input type="radio" name="radios" id="radio1" value="1" /><label
						for="radio1"><span class="gender">남자</span></label> &nbsp;&nbsp; <input
						type="radio" name="radios" id="radio2" value="2" /><label
						for="radio2"><span class="gender">여자</span></label></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div>
							...
							@ <input name="email2" type="text" class="emailBox2">
							<div class="select">
								<select name="email_select" title="이메일주소 선택" class="email3" id="email2">
