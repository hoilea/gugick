...
<script type="text/javascript">
	...
	function confirmId() {
		...
		url = ("idCheck3.jsp?id=" + document.getElementById("userId").value);
		open(
				url,
				"confirm",
...
<body>
	...
	<div class="box-container">
		...
		<form method="post" action="join3Ok.jsp"  onsubmit="return check()" accept-charset="utf-8"
			class="form-box">
			...
			<table class="table input_table">
				...
				<tr>
					...
					<td><input name="userId" id="userId" type="text"
						...
						style="width: 350px" /> <input type="button" id="btnCheck"
