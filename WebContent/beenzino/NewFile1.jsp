...
<body>
    ...
    <header>
                    ...
                    <img alt="../beenzino/poro.png" src="카카오이미지">
                    <div class="intro">
                    <br><br><br><br><br><br><br><br>
                        <h1 class="name">safety</h1>

                        <span class="skills">돈좀 주라 응?  <br><br><br><br><br><br><br><br><br><br></span>
                    </div>
                        ...
                        <div class="modal-body">
							...
							펼쳤습니다. 유니세프와 함께하는 나눔의 첫걸음, 모이면 기적이 만들어집니다.
                            </p>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <p>
                              <form action="travis.jsp">
                                ...
                                <img src="../image/wowowo.png"  alt="" value="999">
                                <img src="../image/card.jpg"  alt="" value="888">
